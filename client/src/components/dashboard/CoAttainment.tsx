...
const CoAttainment: React.FC = () => {
    ...
    useEffect(() => {
       //api call here instead of fixed
        ...
        setCoAttainment([
            [2.00, 2.00, 2.00, 2.00, 2.00, 2.00],  //insem
            [2.00, 2.00, 2.00, 2.00, 2.00, 2.00],  //endsem
            [2.00, 2.00, 2.00, 2.00, 2.00, 2.00],  //direc
        ]);

        setOverallAttainment([
            [2.00, 2.00, 2.00, 2.00, 2.00, 2.00],  //direct
            [2.00, 2.00, 2.00, 2.00, 2.00, 2.00],  //indirect
            [2.00, 2.00, 2.00, 0.00, 2.00, 2.00],  //overall
        ]);

        setTarget([2.00, 2.00, 2.00, 2.00, 2.00, 2.00]);
        setAchieved(['Y', 'Y', 'Y', 'Y', 'Y', 'Y']);
    }, []);

    const coHeaders = ['CO1', 'CO2', 'CO3', 'CO4', 'CO5', 'CO6'];
